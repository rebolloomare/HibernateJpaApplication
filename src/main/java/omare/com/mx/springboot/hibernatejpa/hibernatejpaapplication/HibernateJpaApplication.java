...
public class HibernateJpaApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		logger.info("User id -> {} ", personJpaRepository.findById(10001));
		logger.info("Inserting 10004 -> {} ",
			personJpaRepository.insert(new Person(10004, "Omar", "Mexico", new Date())));
		logger.info("Update 10003 -> {} ",
			personJpaRepository.update(new Person(10003, "Omare2", "Escocia", new Date())));
